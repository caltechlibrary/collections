...
<div class="row">
  <div class="column">
    <a href="http://www.caltech.edu/" title="Caltech Home" id="logo">
      <img src="<?php print $logo; ?>" alt="Caltech">
    </a>
    ...
    <?php if ($top_bar): ?>
      ...
      <nav class="top-bar" data-topbar <?php print $top_bar_options; ?>>
        <ul class="title-area">
          <li class="name"><?php // responsive menu requires an element with the `.name` class ?></li>
